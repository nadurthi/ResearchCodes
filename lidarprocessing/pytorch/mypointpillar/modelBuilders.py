...
from pointcloudmodels.voxelnet import LossNormType, VoxelNet
...
from pointcloudcore.target_assigner import TargetAssigner
from second.builder import anchor_generator_builder

from pointcloudcore import region_similarity


from pointcloudcore.anchor_generator import (AnchorGeneratorStride, AnchorGeneratorRange)
...
from dataset import KittiDataset,prep_pointcloud
import numpy as np
...
def input_reader_builder(input_reader_config,
          model_config,
          training,
          voxel_generator,
