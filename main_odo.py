...
img3=vpdrw.drawMatchedPtsImgpairs(img0,img1,lkpairs.p0[:20,:],lkpairs.p1[:20,:])
fig = plt.figure()
...
img4=vpdrw.drawMatchedPtsImgpairs(img0,img1,ptpairs.p0[:20,:],ptpairs.p1[:20,:])
fig = plt.figure()
...
Kr=np.array([[718.856 ,   0.    , 607.1928],
       [  0.    , 718.856 , 185.2157],
       [  0.    ,   0.    ,   1.    ]])
pt3d=vpst.compute_3D_points_stereopair(ptpairs.p0,ptpairs.p1,Kl,Kr,f,b_rgb)
