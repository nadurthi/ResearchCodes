...
class MapillaryLikeInstanceDataset(FileListDataset):
    def __init__(
        ...
        # note: in case of mapillary the min sizes are always based on the
        # sizes in quarter resolution!
    ...
    def load_annotation(self, img, img_filename, annotation_filename):
        annotation_filename_without_id = tf.string_split(
            [annotation_filename], ':').values[0]
