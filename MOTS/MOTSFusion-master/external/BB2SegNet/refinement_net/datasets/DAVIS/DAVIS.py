...
DAVIS_FLOW_DEFAULT_PATH = "/fastwork/" + \
    username() + "/mywork/data/DAVIS_data/"
DAVIS_LUCID_DEFAULT_PATH = "/fastwork/" + \
    username() + "/mywork/data/DAVIS_data/lucid/"
DAVIS2017_LUCID_DEFAULT_PATH = "/fastwork/" + \
    username() + "/mywork/data/DAVIS2017_data/lucid/"
...
class DAVISDataset(FileListDataset):
    ...
    def read_inputfile_lists(self):
        ...
        imgs, ans = read_image_and_annotation_list(
...
class DAVIS2017Dataset(FileListDataset):
    ...
    def read_inputfile_lists(self):
        ...
        imgs, ans = read_image_and_annotation_list_2017(
            self.data_dir + list_file, self.data_dir)
        return imgs, ans
