...
#%%
metalog="""
ACC 2021 IMM+JPDA paper simulations
Author: Venkat
Date: June 4 2020
...
simmanger = uqsimmanager.SimManager(t0=0,tf=55,dt=1,dtplot=0.1,
                                  simname="ACC-2021-JPDA-IMM",savepath="simulations",
                                  workdir=os.getcwd())
...
R = block_diag((10)**2, (5*np.pi/180)**2)
...
filterer = uqsigf.TargetSigmaKF(sigmamethod = quadcub.SigmaMethod.CUT8)
jpdamot = jpda.JPDAMOT(filterer,recordMeasurementSets=False,PD = 0.85,V=1000,uf=None, Gamma=15 )
jpdamot.sensorset = sensorset
jpdamotlist['CUT8JPDA']=jpdamot
...
jpdamot = jpda.JPDAMOT(filterer,recordMeasurementSets=False,PD = 0.85,V=1000,uf=None, Gamma=15 )
jpdamot.sensorset = sensorset
jpdamotlist['CUT8IMMJPDA']=jpdamot


MethodOrder = ['EKFJPDA','UKFJPDA' ,'CUT8JPDA'  ,'EKFIMMJPDA','UKFIMMJPDA','CUT8IMMJPDA']
